/*==============================================================================
  Elections - Seed Data
  ----------------------------------------------------------------------------
  נתוני דוגמה בלבד. יש להריץ *אחרי* schema.sql (הוא יוצר את המסד והטבלאות).

  הנתונים מסודרים לפי סדר התלויות (טבלאות-אב לפני טבלאות-בן), כך שכל
  ההצבעות תואמות למפתחות הזרים ונטענות בבדיקה מלאה (ללא השבתת אילוצים).
==============================================================================*/
